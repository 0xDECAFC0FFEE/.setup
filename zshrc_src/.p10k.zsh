# Generated by Powerlevel10k configuration wizard on 2020-10-25 at 00:49 PDT.
...
() {
  ...
  function my_git_formatter() {
    ...
    typeset -g my_git_format=$res"%F{008})"
  }
  ...
  # Custom prefix.
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_PREFIX='%F{008}\uFA1A'
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%F{cyan}ssh %F{033}%B%n@%m'
  # Context format when in SSH without privileges: user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='%F{cyan}ssh %F{033}%n@%m'
  # Default context format (no privileges, no SSH): user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%F{cyan}ssh %F{033}%n@%m'
